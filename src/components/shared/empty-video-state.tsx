...
export function EmptyVideoState() {
  return (
    <div className="flex min-h-48 flex-col items-center justify-center rounded-[20px] border border-dashed border-white/[0.12] bg-white/[0.025] px-5 py-8 text-center sm:min-h-56">
